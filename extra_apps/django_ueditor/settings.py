...
TOOLBARS_SETTINGS = {
    ...
    "normal": [['source', '|', 'undo', 'redo', '|', 'bold', 'italic', 'underline', 'removeformat', 'formatmatch',
                'autotypeset', '|',
                'forecolor', 'backcolor', "justifyleft", "justifycenter", "justifyright", "insertorderedlist",
                "insertunorderedlist", '|',
                ...
                'splittocols'],
               ['paragraph', "fontfamily", "fontsize", 'link', 'unlink', 'simpleupload', 'insertimage', 'insertvideo',
